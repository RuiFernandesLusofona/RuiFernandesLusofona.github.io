...
function criarProduto(produto) {
    ...
    const removeDescricao = document.createElement('button');
    removeDescricao.innerText = "- Remover Descricao";
    article.append(removeDescricao);
    removeDescricao.addEventListener('click', () => {
        removerDescricao(produto);
    });
    return article;
}
...
function removerDescricao() {
    ...
    descricao.innerHTML = produto.title;
...
function criarProdutoCesto(produto) {
    ...
    const removeTudo = document.createElement('button');
    removeTudo.innerText = "- Remover Tudo";
    article.append(removeTudo);
    removeTudo.addEventListener('click', () => {
        removerTudo(produto);
    });
...
function removerTudo(produtoARemover) {
    
    let listaProdutos = JSON.parse(localStorage.getItem('produtos-selecionados'));

    listaProdutos = listaProdutos.filter(produto => produto.produtos !== produtoARemover.produtos);
